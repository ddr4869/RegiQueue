...
type Course struct {
	...
	CourseName int `json:"course_name,omitempty"`
...
func (*Course) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case course.FieldID, course.FieldCourseName:
...
func (c *Course) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", c.CourseName))
	builder.WriteString(", ")
